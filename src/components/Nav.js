            ...
            {!loading && (
                <>
                    ...
                    <div className="fixed bottom-4 right-4 z-40  sm:right-4">
                        <a href="https://wa.me/+212659377813" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center   bg-green-500  rounded-full p-4 shadow-md hover:bg-green-600 focus:outline-none focus:shadow-outline-green active:bg-green-800">
